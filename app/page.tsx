...
export default function Home() {
  ...
  return <main>
    ...
    <section className="brand-network" aria-labelledby="brand-network-title"><div><p className="eyebrow dark"><span/> SELLSWELL &amp; 8000 MILES</p><h2 id="brand-network-title">{lang==="zh"?"事为与八千里路，同一团队协同全球业务":"SellsWell and 8000 Miles, one team for global growth"}</h2></div><div className="brand-network-copy"><p>{lang==="zh"?"福州事为电子商务有限公司是官网及自营电商主体；福州八千里路电子商务有限公司负责国内与海外供应链合作；广州八千里路信息科技有限公司聚焦欧美电商运营、AI应用、内容增长及海外市场。三家关联公司由同一团队协同运营。":"Fuzhou SellsWell operates this website and our self-operated commerce business. Fuzhou 8000 Miles leads supply-chain partnerships, while Guangzhou 8000 Miles focuses on Europe and US commerce, AI, content growth and overseas markets. The three affiliated companies operate as one team."}</p><div><a href="/insights/fuzhou-sellswell-company">{lang==="zh"?"认识福州事为电商":"About Fuzhou SellsWell"} ↗</a><a href="/insights/sellswell-and-8000-miles">{lang==="zh"?"了解事为与八千里路":"SellsWell & 8000 Miles"} ↗</a><a href="/partners">{lang==="zh"?"探索供应链合作":"Explore partnerships"} ↗</a></div></div></section>
