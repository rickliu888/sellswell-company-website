...
export default function Home() {
  ...
  return <main>
    ...
    <section className="team-section" id="about"><div className="team-images"><ProgressiveImage className="team-main" src="/assets/team/team-cliff-hd-16x9-v2.jpg" optimizedBase="/assets/optimized/team/team-cliff-hd-16x9-v2" width={2560} height={1440} sizes="(max-width: 1050px) 100vw, 62vw" alt="事为与八千里路团队海边山崖团建"/><ProgressiveImage className="team-small" src="/assets/team/team-coast.jpg" optimizedBase="/assets/optimized/team/team-coast" width={1600} height={900} sizes="(max-width: 1050px) 58vw, 29vw" alt="事为与八千里路团队团建"/></div><div className="team-copy"><p className="eyebrow dark"><span/> PEOPLE & CULTURE</p><h2>{lang==="zh"?"年轻、专业，一起把事情做成":"Young, professional and built to deliver"}</h2><p>{lang==="zh"?"我们来自互联网与跨境一线，相信长期主义，也愿意让优秀伙伴共享公司的长期成长。":"We come from frontline internet and global commerce teams, believe in long-term value, and share growth with exceptional people."}</p><Link href="/about">{lang==="zh"?"走进事为团队":"Meet our team"} ↗</Link></div></section>
