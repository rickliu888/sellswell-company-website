...
export default function SiteFooter({lang="zh"}:{lang?:"zh"|"en"}){
  return <footer>
    ...
    <div className="footer-secondary">
      ...
      <div className="footer-legal"><a className="footer-insights" href="/insights">{lang==="zh"?"事为资讯":"Insights"}</a><a href="/privacy">{lang==="zh"?"隐私政策":"Privacy Policy"}</a><a href="/terms">{lang==="zh"?"使用条款":"Terms of Use"}</a></div>
    </div>
