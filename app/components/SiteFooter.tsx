...
export default function SiteFooter({lang="zh"}:{lang?:"zh"|"en"}){
  return <footer>
    <a className="site-footer-logo" href="/" aria-label={lang==="zh"?"返回首页":"Return home"}><img src="/assets/brand/logo-white.png" width="2235" height="764" loading="lazy" decoding="async" alt="SellsWell"/></a>
