...
export default function SiteFooter({lang="zh"}:{lang?:"zh"|"en"}){
  return <footer>
    <Link className="site-footer-logo" href="/" aria-label={lang==="zh"?"返回首页":"Return home"}><img src="/assets/brand/logo-white.png" width="2235" height="764" loading="lazy" decoding="async" alt="SellsWell"/></Link>
    ...
    <div className="footer-legal"><Link href="/privacy">{lang==="zh"?"隐私政策":"Privacy Policy"}</Link><Link href="/terms">{lang==="zh"?"使用条款":"Terms of Use"}</Link></div>
